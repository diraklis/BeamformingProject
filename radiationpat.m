...
for o=1:length(theta)
    ...
    angleofzeros(o,1:end)=findzeros(theta_zeros,mins,o);
    [sidelobes,angleofzeros(o,1:end),AF(o,1:end),A1,w_nsb1] = optimizing(atheta,theta,theta_zeros,x,sidelobes,angleofzeros(o,1:end),AF(o,1:end),theta1,w_nsb1,A1,o,th,elements,bd,Pn);
